        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">在线测试系统</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">姜涛
                        </div>
                    </li>
                    ...
                    <li>
                        <a class="J_menuItem" href="Park/index">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">车位管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="Park/index?cmd=enter">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">停入车辆</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="Park/index?cmd=leave">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">车辆离开</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="J_menuItem" href="User?cmd=logout">
                            <i class="fa fa-home"></i>
